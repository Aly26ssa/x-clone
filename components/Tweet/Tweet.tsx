...
import { FaRegComment, FaRetweet, FaRegHeart, FaShare, FaHeart, FaChartBar } from "react-icons/fa";
...
export const Tweet = ({ tweetId, avatarUrl, name, handle, time, content, comments, retweets, likes, onDelete }: TweetProps) => {
        ...
        <div className={styles.tweet}>
            ...
            <div className={styles.tweetContent}>
                <div className={styles.header}>
                    ...
                    {showMenu && (
                        <div className={styles.menu}>
                            <div onClick={handleDelete} className={styles.menuItem}>Delete</div>
                ...
                <div className={styles.actions}>
                    ...
                    <span>
                        {Math.floor(Math.random() * 500000 + 1000).toLocaleString()}
                    </span>{" "}
