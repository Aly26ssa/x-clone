...
const MainContent = () => {
    ...
    const avatarUrl = user ? 'https://avatars.githubusercontent.com/u/201373379?s=400&u=711e117beb0d356e837ddaa61a5ca7a996ec6dc4&v=4': null;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (newTweet.trim().length > 1 && user) {
      try {
        ...
        const date = new Date();
        const newTweetData = { id: docRef.id, ...tweetData, time: date.toLocaleDateString("en-US", {
            year: "numeric",
            month: "long",
            day: "numeric",
          }),
